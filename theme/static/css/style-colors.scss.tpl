...
{# /* Julia Design: escala fluida mobile-first (clamp) — alineada a settings.txt */ #}
...
h1, .h1 {
  font-size: var(--julia-text-h1);
  line-height: 1.15;
  font-weight: 700;
}

h2, .h2 {
  font-size: var(--julia-text-h2);
  line-height: 1.2;
...
h5, .h5,
h6, .h6 {
  font-size: clamp(0.9375rem, 0.35vw + 0.8rem, 1.125rem);
  line-height: 1.3;
  font-weight: 700;
}
