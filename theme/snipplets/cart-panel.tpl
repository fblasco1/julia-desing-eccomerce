...
{% if has_free_shipping and cart.free_shipping is defined and cart.free_shipping.min_price_free_shipping is defined and cart.free_shipping.min_price_free_shipping.min_price_raw > 0 %}
