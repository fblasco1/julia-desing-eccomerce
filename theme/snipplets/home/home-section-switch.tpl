{% if section_select == 'julia_hero' %}

	{% set has_julia_hero_content = settings.julia_hero_title or settings.julia_hero_subtitle or settings.julia_hero_cta_label or ('julia_hero.jpg' | has_custom_image) %}
	{% if show_help or (show_component_help and not has_julia_hero_content) %}
...
{% elseif section_select == 'products' %}
    ...
    {#  **** Featured products ****  #}
    {% if show_help or (show_component_help and (has_products is not defined or not has_products)) %}
