...
{% if sections is defined and sections.primary is defined and sections.primary.products %}
    <section class="section-featured-home" id="julia-home-featured-swiper" data-store="home-products-featured">
        <div class="container">
            <div class="row">
                    ...
                    <div class="js-swiper-featured swiper-container">
                        <div class="swiper-wrapper">
                            {% for product in sections.primary.products %}
                                {% include 'snipplets/grid/item.tpl' with { slide_item: true, section_name: 'primary' } %}
                            {% endfor %}
