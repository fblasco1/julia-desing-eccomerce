		...
		<div class="js-ship-free-rest">
			...
			<div class="js-ship-free-rest-message ship-free-rest-message">
				...
				<div class="ship-free-rest-text bar-progress-condition transition-soft">
					<strong class="text-accent">{{ "Envío gratis" | translate }}</strong> {{ "superando los" | translate }} <span>{% if cart.free_shipping is defined and cart.free_shipping.min_price_free_shipping is defined %}{{ cart.free_shipping.min_price_free_shipping.min_price }}{% endif %}</span>
				</div>
			</div>
		</div>
	</div>
