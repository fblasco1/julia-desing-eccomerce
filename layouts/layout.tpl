...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:fb="http://www.facebook.com/2008/fbml" xmlns:og="http://opengraphprotocol.org/schema/" lang="{% for language in languages %}{% if language.active %}{{ language.lang }}{% endif %}{% endfor %}">
    ...
    <body class="julia-theme-spruce {% if customer %}customer-logged-in{% endif %} template-{{ template | replace('.', '-') }}">
        ...
        {# Julia Design — carrusel infinito home (marquee, static/js/spruce-carousel.js) #}
        {% if template == 'home' %}
            <script src="{{ 'js/spruce-carousel.js' | static_url }}" defer></script>
        {% endif %}
    </body>
</html>
